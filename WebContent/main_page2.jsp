...
<body>
    ...
    <div data-role="content">
	    ...
	    <div class = "thismonth">
	        <a  data-role="button" data-inline="true" href="artist2.jsp">
	            이달의 작가
	        </a>
        ...
        <div>
        	<a data-role="button" data-inline="true" href="junsi2.jsp">
        		이달의 전시
        	</a>
        	<hr style="height:1px; background-color:#ccc; border:0; margin-top:12px; margin-bottom:12px;">
        	<table>
        ...
        <div>
        	<a data-role="button" data-inline="true" href="digital2.jsp">
        		디지털 전시실
        	</a>
        	<hr style="height:1px; background-color:#ccc; border:0; margin-top:12px; margin-bottom:12px;">
        ...
        <div>
        	<a data-role="button" data-inline="true" href="last2.jsp">
        		지난 호 보기
        	</a>
        	<hr style="height:1px; background-color:#ccc; border:0; margin-top:12px; margin-bottom:12px;">
        	<table>
